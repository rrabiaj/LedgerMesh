...
public class TransactionEventConsumer {
    ...
    public void consumeTransactionCreatedEvent(TransactionCreatedEvent event) {
        logger.info("Budget Service received transaction event: {}",event);

        logger.info("Evaluating budget for userId={}, category={}, amount={}",event.getUserId(),event.getCategory(),event.getAmount());
